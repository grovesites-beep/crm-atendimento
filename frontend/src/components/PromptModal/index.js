...
// Lista alinhada com o backend / TALK.AI
// Mantém os GPTs e apenas o Gemini 2.0 Flash
const allowedModels = [
  "gpt-4.1-mini",
  "gpt-4.1",
  "gemini-2.0-flash",
    ...
    const fetchPrompt = async () => {
      ...
      try {
        ...
        setPrompt({
          ...
          // garante que usamos apenas modelos permitidos
          model: allowedModels.includes(data.model)
            ? data.model
            : "gpt-4.1-mini",
        });
      } catch (err) {
