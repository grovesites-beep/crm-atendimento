      ...
      <div className={classes.serachInputWrapper}>
        ...
        >
          {isFilterActive ? (
            ...
            <FilterX className={classes.icon} />
          )}
        </IconButton>
      </div>
          ...
          <Grid item>
            ...
            {user.profile === "admin" && (
              ...
              >
                ...
                >
                  <ListX style={{ color: theme.mode === "light" ? "green" : "#FFF" }} className={classes.icon} />
                </IconButton>
              </Badge>
            )}
            <Badge
                ...
                <Grid item>
                  <Typography
                    style={{
                      ...
                      fontSize: 10,
                      fontWeight: 600,
                      textTransform: "none", // <-- ISSO resolve 100%
                    }}
                  >
