...
export const FlowBuilderConfig = () => {
  ...
  const actions = [
    ...
    },
    {
      icon: (
        <SiOpenai
          style={{ color: "#F7953B", width: 24, height: 24 }}
        />
      ),
      name: "OpenAI/Gemini",
      type: "openai",
  ...
  return (
    <Stack sx={{ height: "100vh", backgroundColor: "#0f172a" }}>
      {/* ===================== MODAIS ===================== */}
      ...
      >
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Typography sx={{ fontSize: 20, fontWeight: 600, color: "#e5e7eb" }}>
            🧠 Flow Builder
          </Typography>

          <Stack direction="row" spacing={1}>
            <Button variant="outlined" color="inherit" startIcon={<UploadFileIcon />} onClick={() => setImportModal(true)}>
              Importar
            </Button>
            <Button variant="outlined" color="inherit" startIcon={<GetAppIcon />} onClick={() => exportFlow(id)}>
              Exportar
            </Button>
      ...
      {!loading && (
        <Stack direction="row" sx={{ flex: 1 }}>
          ...
          <Stack sx={{ flex: 1, position: "relative" }}>
            ...
            >
              <Typography fontSize={13} color="#e5e7eb">
                ⚠️ Não se esqueça de salvar seu fluxo
              </Typography>
            </Paper>
